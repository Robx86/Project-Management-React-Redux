...
export default function IndexPage() {
  return (
    <>
      <div className="flex items-center justify-center w-full h-full pt-8 px-4">
        <div className="bg-white dark:bg-white rounded shadow max-w-xl py-6 sm:px-8 px-4">
          <div className="flex items-center justify-between">
            <p className="cursor-pointer text-base sm:text-2xl font-semibold leading-4 text-">
              React Project
            </p>
            <div className="relative">
              <button className="focus:outline-none">
                <svg
                  className="dropbtn dark:text-gray-700 text-gray-800"
          ...
          <p className="text-sm leading-5 mt-4 text-black sm:w-10/12">
            Apenas um projeto de exemplo para ToDos em que o usuário poderá
            cadastrar projetos e também a lista de ToDo
          </p>
          <div className="mt-8">
            <div className="flex flex-col justify-end">
              ...
              <div className="bg-gray-100 rounded-full mt-3 h-2 w-full">
                <div className="bg-gray-600 w-5/6 h-2 rounded-full" />
              </div>
            </div>
