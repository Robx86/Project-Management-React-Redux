...
export default function index() {
  ...
  return (
    <div className=" mb-10 border-gray-700 border-t-2 container mx-auto">
          ...
          <div className=" flex flex-row justify-between">
            ...
            <div className="lg:flex hidden flex-auto justify-between flex-row">
              <div className=" xl:pl-16 lg:pl-4">
                ...
                <h2 className=" font-bold text-xl leading-5 text-white">
                  Project ToDo React
                </h2>
              </div>
              <div className="flex flex-row lg:space-x-3 xl:space-x-4">
                ...
                <button className="ml-5 text-yellowComplement border-2 border-yellowComplement px-4 py-1 hover:bg-yellowComplement rounded-sm font-semibold ease-in-out delay-150 hover:text-black duration-150">
                  <p>Share</p>
                </button>
                {/* Vertical Line */}
